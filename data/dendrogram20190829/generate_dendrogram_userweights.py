...
## Set the weights
Jaccardw, GKw, DDSw, AIw = float(sys.argv[1]), float(sys.argv[2]), float(sys.argv[3]), float(sys.argv[4])

## Define inputs
annotation_matrix = "../dendrogram20190514/KS_precomputed_1405_hmmalign_trimmed_renamed.annotationtable.tsv"
blasttable = "../dendrogram20190514/full.dbp" ## Tab blast
